...
//
//public class EngineFuture extends Application {
//    //ゲームのグローバル変数
//    Player playerEngine;
...
//    }
//
//    public EngineFuture() throws Exception {
//    }
//
//    int p = 0;
//
...
//
////        playerEngine.changeType(ColorDetectionCam.colorType);
//
//        //テスト用
...
//        public void loadAttackObject() throws Exception {
//            // 赤い攻撃オブジェクトを読み込む
...
////                    redAttackZ = zShow; greenAttackZ = clearZ; blueAttackZ =clearZ;
////                } else if (Objects.equals(str, "green")) {
////                    greenAttackZ = zShow; redAttackZ = clearZ; blueAttackZ = clearZ;
////                } else if (Objects.equals(str, "blue")) {
////                    blueAttackZ = zShow; redAttackZ = clearZ; greenAttackZ = clearZ;
////                }
////            }
////            else{
...
//                zRed = zShow; zGreen = clearZ; zBlue = clearZ;
//            }
//            else if(Objects.equals(this.str, "green")) {
//                zRed = clearZ; zGreen = zShow; zBlue = clearZ;
//            }
//            else {
//                zRed = clearZ; zGreen = clearZ; zBlue = zShow;
//            }
//
//            if (isAttack) {
//                if (Objects.equals(str, "red")) {
