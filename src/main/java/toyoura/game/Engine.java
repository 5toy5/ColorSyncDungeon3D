...
//            player.setAttackObjectScale(5.0, 5.0, 5.0);
//        }
//        //テスト用
//        if (isKeyPressed(KeyCode.DIGIT9)) {
//            disc.setDiscScale(1.01, 1.01, 1.01);
//        }
//
...
//                new Rotate(70, snowmanCenterX, snowmanCenterY, snowmanCenterZ, Rotate.X_AXIS),
...
//            this.speed = 1;
//            this.radius = 10;
//            sphere = new SphereObject(x, y, 30, type);
//            this.startTime = System.currentTimeMillis();
...
//
//        void clear() {
//            root.getChildren().remove(sphere.getGroup());
//        }
//
//        //x,y,type
//        void display() {
...
//        Group groupBlue;
//
//        Snowman(double x, double y, double rotate, double baseRadius, double topRadius, double offsetY, String str) throws Exception {
//            this.x = x;
//            this.y = y;
////            this.zRed = zShow;
////            this.zGreen = clearZ;
...
//        public void addRedAttackObject() throws Exception {
//            File file = new File("src/main/resources/3dmodels/redAttackRadius100.obj");
//            ObjImporter importer = new ObjImporter();
//            Model3D model = importer.load(file.toURI().toURL());
//            Group importedObject = model.getRoot();
////            importedObject.getTransforms().add(new Rotate(180, Rotate.X_AXIS));
//            importedObject.getTransforms().add(new Scale(attackSize, attackSize, 1.0));
//            groupRed.getChildren().add(importedObject);
//        }
//
